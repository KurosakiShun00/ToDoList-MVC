...
* **Operazioni CRUD complete:** Creazione, lettura, aggiornamento e cancellazione di liste e dei task all'interno di
  liste.
...
* **Documentazione Swagger:** Interfaccia grafica integrata per esplorare e testare gli endpoint API direttamente dal
  browser.
